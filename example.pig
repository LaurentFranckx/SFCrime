...
store count_by_object_ordered into 's3n://laurentfranckx/example-results';

--records_count = FOREACH (GROUP count_by_object_ordered ALL) GENERATE COUNT(count_by_object_ordered);
--DUMP records_count;
